...
let audioFra = new Audio('./sound/Josquin.mp3');
...
let audioFre = new Audio('./sound/Freestrina.mp3');
...
let audioCam = new Audio('./sound/Cam.mp3');
...
let audioPjo = new Audio('./sound/Pjod.mp3');
...
let audioEdv = new Audio('./sound/Edv.mp3');
...
let audioSer = new Audio('./sound/Orlando.mp3');
